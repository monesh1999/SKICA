...
const ResetPassword =()=>{
  ...
  const onSubmitEmail = async (e) =>{
   ...
   const handleVerify = async () =>{
    ...
    if(otp.length !== 6){
      toast.error("please enter the all 6 digits of the OTP.");
      return;
    }
    setOtp(otp);
  ...
  const onSubmitNewPassword = async(e)=>{
    ...
    return(
        <div className="email-verifiy-container d-flex align-items-center justify-content-center vh-100 position-relative"
        style={{background: "linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 100%)",
        borderRadius: "0",}}>
        ...
        {!isEmailSent &&(
            <div className="rounded-4 p-5 text-center bg-white" style={{width:"100",maxWidth:'400px'}}>
                <h4 className="mb-2 text-info">Reset Password</h4>
                <p className="mb text-secondary">Enter your registered email address</p>
